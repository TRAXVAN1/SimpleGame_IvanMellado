...
public class Main implements ApplicationListener {
    ...
    private void draw(){
        ...
        // emmagatzema el worldWidth i worldHeight com a variables locals
        float worldWidth = viewport.getWorldWidth();
        float worldHeight = viewport.getWorldHeight();


        spriteBatch.draw(backgroundTexture, 0, 0, worldWidth, worldHeight); //dibuixa el fons
    ...
    public void dispose() {
        ...
        //en el tutorial no ho fa pero com hem apres a lliberar recursos cuan tanquem la app en el adoid he buscar con fer-ho en java
